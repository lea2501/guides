# Usage
```shell
$ chocolate-heretic -fullscreen -iwad ~/games/doom/maps/iwads/heretic.wad -file ~/games/doom/maps/heretic/vanilla/ ~/games/doom/mods/vanilla/palette/dimm_pal/her-pal.wad -savedir ~/games/doom/savegames/heretic/ -skill 3 -warp 1 1
```
